    ...
    for epoch in range(num_epochs):
        ...
        for phase in range(2):
            ...
            if phase == 1 and epoch_acc > best_acc:
                best_acc = epoch_acc
                best_model_wts = copy.deepcopy(model.state_dict())
                torch.save(model, './TrainedModels/FaceAttention_AlignedModel_FullTrain_4para_adam_dropout_BN_SoftmaxLr01')
...
model = train_model(model_ft, criterion, optimizer_ft, num_epochs=epochs)
