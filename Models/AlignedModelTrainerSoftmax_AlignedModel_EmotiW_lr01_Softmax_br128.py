...
maxFaces = 15
numClasses = 3
non_aligned_path = './TrainedModels/AlignedModel_EmotiW_lr01_Softmax_br128'
    ...
    for epoch in range(num_epochs):
        ...
        for phase in range(2):
            ...
            if phase == 1 and epoch_acc > best_acc:
                best_acc = epoch_acc
                best_model_wts = copy.deepcopy(model.state_dict())
                torch.save(model, './TrainedModels/AlignedModelTrainerSoftmax_AlignedModel_EmotiW_lr01_Softmax_br128')
