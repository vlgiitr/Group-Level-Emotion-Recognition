...
maxFaces = 15
numClasses = 3
aligned_path = '../TrainedModels/TrainDataset/AlignedModel_EmotiW_lr001'
    ...
    def forward(self, face_features_initial, numberFaces, labels, phase):
        ...
        for j in range(face_features_initial.shape[0]):
            ...
            if phase == 0:
                ...
                face_features[j, :, :] = self.align_model.forward(face, None)
...
model_ft = FaceAttention(align_model)
        ...
        for phase in range(2):
            ...
            for i_batch, sample_batched in enumerate(dataloaders):
                ...
                with torch.set_grad_enabled(phase == 0):
                    outputs = model(face_features, numberFaces, labels, phase)
            ...
            if phase == 1 and epoch_acc > best_acc:
                best_acc = epoch_acc
                best_model_wts = copy.deepcopy(model.state_dict())
                torch.save(model, '../TrainedModels/TrainDataset/AlignedModelTrainerLSoftmax_AlignedModel_EmotiW_lr001')
